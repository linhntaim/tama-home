...
export const routes = [
    {
        ...
        children: [
            ...
            //
            {
                path: 'holding',
                name: 'holding',
                component: () => import(/* webpackChunkName: "view-holding" */ '@/resources/views/pages/holding/Index'),
            },
            {
                path: 'trading',
                name: 'trading',
                component: () => import(/* webpackChunkName: "view-trading" */ '@/resources/views/pages/trading/Index'),
            },
            //
            {
                path: '/',
